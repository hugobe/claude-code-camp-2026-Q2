...
| `backend:` | `:anthropic` | `:anthropic`, `:openai`, `:gemini`, `:ollama`, `:ollama_cloud`, or `:lm_studio` |
| `api_key:` | `ENV["ANTHROPIC_API_KEY"]` | API key for the chosen backend (not needed for `:ollama` or `:lm_studio`) |
